...
const useEnquiryValidation = () => {
    ...
    const validateInputs = (enquiry: App.Enquiry): boolean => {
        ...
        if (enquiry.category === "" || typeof (enquiry.category) === "undefined") {
            setFailedValidation("category", "Please enter an enquiry category.")
        }
...
export default useEnquiryValidation